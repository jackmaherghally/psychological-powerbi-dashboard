...
![Dashboard Preview](Screenshot (3<img width="1138" height="731" alt="1000114226" src="https://github.com/user-attachments/assets/94443ca2-047b-48a6-b622-b67ea4876e11" />
).png)

### 📊 Key Features
* **Sales Analysis:** Visualizes the total sum of amounts by category.
* **Interactive Filtering:** Includes Slicers for **State** (Geography) and **Date Range**, allowing users to filter data dynamically.
* **Trend Visualization:** Tracks sales performance over time (Yearly analysis).
* **Customer Insights:** Detailed breakdown of customer transactions.
